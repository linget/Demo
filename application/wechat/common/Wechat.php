...
use app\wechat\common\WechatCrypt;
...
class Wechat {
    ...
    public function replyText($text){
        ...
        return $this->response($arr, self::MSG_TYPE_TEXT);
    }
    ...
    public function replyImage($media_id){
        ...
        return $this->response($arr, self::MSG_TYPE_IMAGE);
    }
    ...
    public function replyVoice($media_id){
        ...
        return $this->response($arr, self::MSG_TYPE_VOICE);
    }
    ...
    public function replyVideo($media_id, $title, $discription){
        ...
        return $this->response($arr, self::MSG_TYPE_VIDEO);
    }
    ...
    public function replyMusic($title, $discription, $musicurl, $hqmusicurl, $thumb_media_id){
        ...
        return $this->response($arr, self::MSG_TYPE_MUSIC);
    }
